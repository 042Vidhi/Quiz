...
[
    ...
    {
        Sno:2,
        ques:"When a new employee joined, their rating was 3 points lower than the highest score. What was the rating of the new employee?",
        correct_ans:"6",
        user_ans:"",
    ...
    {
        Sno:3,
        ques:"Find the average call resolution percentage across the 4 agents",
        correct_ans:"59.5%",
        user_ans:"",
    ...
    {
        Sno:4,
        ques:"If agent C's average handling time goes up by 5 percent, what would be their new average call handling time? (Answer in mins upto 1 decimal place)",
        correct_ans:"8.4",
        user_ans:"",
    ...
    {
        Sno:5,
        ques:"What is the total sales for the first five months?",
        correct_ans:"610000",
        user_ans:"",
    ...
    {
        Sno:6,
        ques:"What is the average sales per month for the given period?",
        correct_ans:"122000",
        user_ans:"",
    ...
    {
        Sno:7,
        ques:"Calculate the percentage increase in sales from February to March.(Round off to nearest Integer)",
        correct_ans:"58",
        user_ans:"",
    ...
    {
        Sno:8,
        ques:"Identify the month with the highest sales and the month with the lowest sales.",
        options : ["March & Feburary","January & Feburary","April & May","March & May"],
        user_ans:"",
        correct_ans:"March & Feburary",
        explanation:"Highest sales month: March with $150,000 & Lowest sales month: February with $95,000",
    },
    {
        Sno:9,
        ques:"Compare the total sales in April and May. How much higher or lower are the sales in May compared to April?",
        correct_ans:"25000",
        user_ans:"",
    ...
    {
        Sno:10,
        ques:"If the trip with an arrival time of 08:00 AM and a departure time of 12:00 PM included an unexpected delay of 45 minutes, at what time did the trip actually depart?",
        correct_ans:"1245",
        user_ans:"",
    ...
    {
        Sno:11,
        ques:"If the cost per person for the trip with an arrival time of 09:30 AM and a departure time of 02:00 PM increased by 15%, what would be the new cost per person?",
        correct_ans:"74.75",
        user_ans:"",
    ...
    {
        Sno:12,
        ques:"Compare the average number of stops for trips that have an arrival time before 11:00 AM to those that have an arrival time after 11:00 AM. Which set of trips has a higher average number of stops?",
        options : ["Trips after 11:00 AM","Trips before 11:00 AM"],
        user_ans:"",
        correct_ans:"Trips after 11:00 AM",
        explanation:"Original cost per person = $65.Increase in cost = Original cost * 15% = $65 * 0.15 = $9.75.New cost per person = Original cost + Increase in cost = $65 + $9.75 = $74.75. The new cost per person would be approximately $74.75 after a 15% increase.",
    },
    {
        Sno:13,
        ques:"If the total revenue generated from a trip with an arrival time of 10:45 AM and a departure time of 03:30 PM was $1750, what was the average cost per person for this trip?",
        correct_ans:"350",
        user_ans:"",
    ...
    {
        Sno:14,
        ques:"The trip with an arrival time of 12:30 PM and a departure time of 06:30 PM experienced an unexpected delay of 30 minutes at one of the stops. What was the total duration of the trip after considering this delay?",
        options:["6 hours 40 mins","7 hours 30 mins","6 hours 30 mins","12 hours 40 mins"],
        user_ans:"",
        correct_ans:"6 hours 30 mins",
